...
def build_crew_emmen(tema: str, palavra_chave: str):
    ...
    links_internos = LINKS_INTERNOS_EMMEN[:]
    ...
    agente_contato = Agent(
        ...
        goal="Anexar assinatura institucional da Dra. Emmen Rocha ao final do HTML, sem alterar o conteúdo anterior.",
...
Saída: HTML com links internos/externos aplicados (sem imagens).
""".strip(),
...
<p><a href="https://draemmenrocha.com.br/contato/" target="_blank" rel="noopener noreferrer">Fale com ela pelo site</a></p>
<p><strong>Dra. Emmen Rocha</strong><br>[Endereço ou localidade, se desejar]</p>
""".strip(),
...
- Ortografia/gramática PT-BR; clareza; tom profissional, direto e acolhedor.
